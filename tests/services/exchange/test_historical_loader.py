...
class TestHistoricalDataLoader:
    ...
    async def test_load_historical_data_success(
        self, historical_loader, mock_binance_manager, sample_ohlcv_data
    ):
        ...
        candles = await historical_loader.load_historical_data(
            symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=100
        )
        # Verify results
        ...
        mock_binance_manager.fetch_ohlcv.assert_called_once_with(
            symbol="BTCUSDT", timeframe="15m", since=None, limit=100
        )
        # Verify statistics
    ...
    async def test_load_historical_data_with_storage(
        self, historical_loader, mock_binance_manager, candle_storage, sample_ohlcv_data
    ):
        ...
        await historical_loader.load_historical_data(
            symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=50, store=True
        )
    ...
    async def test_load_historical_data_without_storage(
        ...
        await historical_loader.load_historical_data(
            symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=50, store=False
        )
    ...
    async def test_data_validation_success(
        ...
        candles = await historical_loader.load_historical_data(
            symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=100, validate=True
        )
        # Validate
    ...
    @pytest.mark.asyncio
    async def test_data_validation_with_gaps(self, historical_loader, sample_ohlcv_data):
    ...
    @pytest.mark.asyncio
    async def test_data_validation_with_duplicates(self, historical_loader, sample_ohlcv_data):
    ...
    @pytest.mark.asyncio
    async def test_data_validation_with_wrong_order(self, historical_loader, sample_ohlcv_data):
    ...
    @pytest.mark.asyncio
    async def test_retry_on_error(self, historical_loader, mock_binance_manager, sample_ohlcv_data):
        ...
        candles = await historical_loader.load_historical_data(
            symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=50
        )
    ...
    @pytest.mark.asyncio
    async def test_max_retries_exceeded(self, historical_loader, mock_binance_manager):
    ...
    async def test_invalid_limit(self, historical_loader):
        ...
        with pytest.raises(ValueError, match="limit must be between"):
            await historical_loader.load_historical_data(
                symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=0
            )
        # Test exceeding max limit
        with pytest.raises(ValueError, match="limit must be between"):
            await historical_loader.load_historical_data(
                symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=1001
            )
    ...
    async def test_load_multiple_symbols_sequential(
        ...
        results = await historical_loader.load_multiple_symbols(
            symbols=["BTCUSDT", "ETHUSDT"], timeframes=[TimeFrame.M15], limit=50, parallel=False
        )
        # Verify results
    ...
    async def test_load_multiple_symbols_with_errors(
        ...
        # Load multiple symbols
        results = await historical_loader.load_multiple_symbols(
            symbols=["BTCUSDT", "ETHUSDT"], timeframes=[TimeFrame.M15], limit=50, parallel=True
        )
    ...
    async def test_rate_limiting(self):
        ...
        loader = HistoricalDataLoader(
            binance_manager=mock_manager, candle_storage=storage, enable_rate_limiting=True
        )
    ...
    @pytest.mark.asyncio
    async def test_empty_response(self, historical_loader, mock_binance_manager):
    ...
    async def test_partial_data_corruption(
        ...
        candles = await historical_loader.load_historical_data(
            symbol="BTCUSDT", timeframe=TimeFrame.M15, limit=11
        )
...
class TestRateLimiting:
    ...
    async def test_rate_limit_disabled(self):
        ...
        storage = CandleStorage()
        loader = HistoricalDataLoader(
            binance_manager=mock_manager, candle_storage=storage, enable_rate_limiting=False
        )
