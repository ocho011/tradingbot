...
from src.indicators.trend_recognition import TrendRecognitionEngine, TrendDirection
...
class TestMarketStructureBreakDetector:
    ...
    def test_bullish_bms_detection(self):
        ...
        candles = [
            create_candle(1000000 + i * 60000, 1.0990, 1.0995, 1.0985, 1.0990)
            for i in range(10)
        ]
        ...
        # Detect BMS
        detected_bms = detector.detect_bms(
            candles,
            [swing_high],
            [],
            start_index=10
    ...
    def test_bearish_bms_detection(self):
        ...
        candles = [
            create_candle(1000000 + i * 60000, 1.0910, 1.0915, 1.0905, 1.0910)
            for i in range(10)
        ]
    ...
    def test_structure_significance_calculation(self):
        ...
        significance = detector._calculate_structure_significance(
            swing_high,
            [swing_high],
            candles
        )
    ...
    def test_multiple_bms_detection(self):
        ...
        candles.append(create_candle(
            1000000 + 10 * 60000, 1.0995, 1.1005, 1.0990, 1.1003, volume=1500.0
        ))
        for i in range(11, 14):
            candles.append(create_candle(
                1000000 + i * 60000, 1.1003, 1.1010, 1.1000, 1.1008, volume=1200.0
            ))

        # Continue to second level
        for i in range(14, 30):
            candles.append(create_candle(
                1000000 + i * 60000, 1.1010, 1.1018, 1.1008, 1.1015
            ))

        # Second BMS - break swing_high_2 at 1.1020
        candles.append(create_candle(
            1000000 + 30 * 60000, 1.1015, 1.1025, 1.1012, 1.1022, volume=1500.0
        ))
        for i in range(31, 34):
            candles.append(create_candle(
                1000000 + i * 60000, 1.1022, 1.1030, 1.1020, 1.1028, volume=1200.0
            ))
